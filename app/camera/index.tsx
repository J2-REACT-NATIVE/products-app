...
export default function CameraScreen() {
  ...
  //! Para verificar los permisos tanto para el acceso a la camara como el acceso a la galeria
  ...
  //!Si no se ha autorizado rl uso de la camara
  ...
  const onShutterButtonPress = async () => {
    ...
    //! Capturamos la uri de la imagen y la almacenamos en el state selectedImage
  ...
  //! reseteamos el state selectedImage
  const onRetakePhoto = () => {
  ...
  //! Si tenemos la imagen renderizamos lo siguiente.
  if (selectedImage) {
    return (
...
// Custom Components
const ShutterButton = ({ onPress = () => {} }: PropsCameraButtons) => {
...
const FlipCameraButton = ({ onPress = () => {} }: PropsCameraButtons) => {
  return (
...
const GalleryButton = ({ onPress = () => {} }: PropsCameraButtons) => {
  return (
...
const ReturnCancelButton = ({ onPress = () => {} }: PropsCameraButtons) => {
  return (
...
//! Para confirmar la fotografia que se acaba de tomar.
const ConfirmImageButton = ({ onPress = () => {} }: PropsCameraButtons) => {
  const dimensions = useWindowDimensions();
  const primaryColor = useThemeColor({}, "primary");
